...
public class TC_11 {
	...
	public static void main(String[] args) throws Exception {
		...
		// Click on Length.
		driver.findElement(By.xpath("//*[@href='convert_length.html']")).click();
		Thread.sleep(3000);

		// Calculation
		driver.findElement(By.xpath("//*[@name='param0']")).sendKeys("20");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(
				"/html/body/div/div[2]/div[1]/div/div[3]/div[1]/div[2]/table/tbody/tr/td[2]/font/b/form/center/p[3]/select/option[6]"))
				.click();
		Thread.sleep(2000);
